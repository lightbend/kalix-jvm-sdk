...
case class FullyQualifiedName(
  ...
  /**
   * The gRPC service interface generated by Akka gRPC (only useful if this FQN actually refers to a service)
   */
  lazy val fullyQualifiedGrpcServiceInterfaceName = s"${parent.javaPackage}.$name"
