 ...
 */
public class SomeMultiMapProvider implements ReplicatedEntityProvider<ReplicatedMultiMap<SomeKey, SomeValue>, SomeMultiMap> {
  ...
  public Serializer serializer() { 
    return Serializers
            .add(new JsonSerializer(SomeKey.class))
            .add(new JsonSerializer(SomeValue.class));
  }
}
