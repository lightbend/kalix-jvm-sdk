 ...
 */
public class CounterProvider implements EventSourcedEntityProvider<CounterState, Counter> {
  ...
  public Serializer serializer() { 
    return Serializers
            .add(new JsonSerializer(Increased.class))
            .add(new JsonSerializer(Decreased.class))
            .add(new JsonSerializer(CounterState.class));
  }
}
