...
abstract class AbstractCounter extends EventSourcedEntity[CounterState] {
  ...
  def increase(currentState: CounterState, increaseValue: org.example.eventsourcedentity.counter_api.IncreaseValue): EventSourcedEntity.Effect[Empty]

  def decrease(currentState: CounterState, decreaseValue: org.example.eventsourcedentity.counter_api.DecreaseValue): EventSourcedEntity.Effect[Empty]
