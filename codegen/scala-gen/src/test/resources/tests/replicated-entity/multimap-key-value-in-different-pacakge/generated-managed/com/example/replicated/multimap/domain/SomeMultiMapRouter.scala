...
class SomeMultiMapRouter(entity: SomeMultiMap)
  extends ReplicatedEntityRouter[ReplicatedMultiMap[com.example.replicated.multimap.domain.key.multi_map_key.SomeKey, com.example.replicated.multimap.domain.value.multi_map_value.SomeValue], SomeMultiMap](entity) {

  override def handleCommand(
      commandName: String,
      data: ReplicatedMultiMap[com.example.replicated.multimap.domain.key.multi_map_key.SomeKey, com.example.replicated.multimap.domain.value.multi_map_value.SomeValue],
      command: Any,
