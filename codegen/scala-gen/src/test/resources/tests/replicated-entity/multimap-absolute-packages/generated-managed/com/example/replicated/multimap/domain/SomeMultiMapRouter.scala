...
class SomeMultiMapRouter(entity: SomeMultiMap)
  extends ReplicatedEntityRouter[ReplicatedMultiMap[com.example.replicated.multimap.domain.multi_map_domain.SomeKey, com.example.replicated.multimap.domain.multi_map_domain.SomeValue], SomeMultiMap](entity) {
