...
class SomeMultiMapProvider private (
    ...
    extends ReplicatedEntityProvider[ReplicatedMultiMap[com.example.replicated.multimap.domain.multi_map_domain.SomeKey, com.example.replicated.multimap.domain.multi_map_domain.SomeValue], SomeMultiMap] {
  ...
  override def additionalDescriptors: Seq[Descriptors.FileDescriptor] =
    EmptyProto.javaDescriptor :: MultiMapDomainProto.javaDescriptor :: multi_map_api.MultiMapApiProto.javaDescriptor :: Nil
}
