...
```shell
curl -XPOST -H "Content-Type: application/json" localhost:9000/com.example.CounterService/Increase -d '{"counterId": "foo", "value": 1}'
```

```shell
curl -XPOST -H "Content-Type: application/json" localhost:9000/com.example.actions.DoubleCounter/Increase -d '{"counterId": "foo", "value": 1}'
```
