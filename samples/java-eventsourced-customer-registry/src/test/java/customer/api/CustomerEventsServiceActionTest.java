...
import customer.api.DirectCustomerEvents;
...
public class CustomerEventsServiceActionTest {
  ...
  public void transformCustomerCreatedTest() {
    ...
    // ActionResult<DirectCustomerEvents.Created> result = testKit.transformCustomerCreated(CustomerDomain.CustomerCreated.newBuilder()...build());
  }
  ...
  public void transformCustomerNameChangedTest() {
    CustomerEventsServiceActionTestKit testKit = CustomerEventsServiceActionTestKit.of(CustomerEventsServiceAction::new);
    // ActionResult<DirectCustomerEvents.NameChanged> result = testKit.transformCustomerNameChanged(CustomerDomain.CustomerNameChanged.newBuilder()...build());
  }
