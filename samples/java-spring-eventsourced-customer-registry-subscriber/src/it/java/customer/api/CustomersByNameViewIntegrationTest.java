...
import kalix.javasdk.testkit.EventingTestKit.Subscription;
...
public class CustomersByNameViewIntegrationTest extends KalixIntegrationTestKitSupport {
  ...
  public void shouldCustomerByName() {
    Subscription customerEvents = kalixTestKit.getStreamSubscription("customer-registry", "customer_events");
