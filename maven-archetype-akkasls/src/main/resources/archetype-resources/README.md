...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/${package}.CounterEntity/Get -d '{"counterId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"counterId": "foo"}' localhost:9000 com.github.octonato.CounterEntity/Get 
ERROR:
  Code: Unknown
