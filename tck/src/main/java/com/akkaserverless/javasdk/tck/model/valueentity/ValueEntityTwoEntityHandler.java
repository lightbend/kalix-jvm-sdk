...
public class ValueEntityTwoEntityHandler extends ValueEntityHandler<String, ValueEntityTwoEntity> {

  public ValueEntityTwoEntityHandler(ValueEntityTwoEntity entity) {
    super(entity);
  }
