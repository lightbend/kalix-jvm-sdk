...
object Dependencies {
  object Kalix {
    ...
    val ProxyVersion = System.getProperty("kalix-proxy.version", "1.1.6")
  }
  ...
  val javaSpringDevTools =
    deps ++= Seq(typesafeConfig, "org.springframework.boot" % "spring-boot-starter" % SpringBootVersion)
