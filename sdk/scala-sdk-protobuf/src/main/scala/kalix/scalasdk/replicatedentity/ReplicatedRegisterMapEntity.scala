...
class ReplicatedRegisterMapEntity[K, V] extends ReplicatedEntity[ReplicatedRegisterMap[K, V]] {
   ...
   */
  override final def emptyData(factory: ReplicatedDataFactory): ReplicatedRegisterMap[K, V] =
    factory.newReplicatedRegisterMap
}
