...
class ReplicatedMapEntity[K, V <: ReplicatedData] extends ReplicatedEntity[ReplicatedMap[K, V]] {
   ...
   */
  override final def emptyData(factory: ReplicatedDataFactory): ReplicatedMap[K, V] =
    factory.newReplicatedMap
}
