 ...
 */
@InternalApi
private[springsdk] object WebClientProviderHolder
    extends ExtensionId[WebClientProviderHolder]
 ...
 */
@InternalApi
private[springsdk] class WebClientProviderImpl(system: ExtendedActorSystem) extends WebClientProvider {
