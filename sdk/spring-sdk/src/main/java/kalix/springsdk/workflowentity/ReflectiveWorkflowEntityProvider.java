...
package kalix.springsdk.workflowentity;
...
import kalix.springsdk.impl.workflow.ReflectiveWorkflowEntityRouter;
...
public class ReflectiveWorkflowEntityProvider<S, W extends WorkflowEntity<S>> implements WorkflowEntityProvider<S, W> {
  ...
  public ReflectiveWorkflowEntityProvider(Class<W> workflowClass, SpringSdkMessageCodec messageCodec, Function<WorkflowEntityContext, W> factory, WorkflowEntityOptions options) {
