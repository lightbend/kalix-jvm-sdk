...
public class ProtoStepBuilder {
   ...
   */
  @ApiMayChange
  public <Input extends GeneratedMessageV3, DefCallInput, DefCallOutput extends GeneratedMessageV3> CallStepBuilder<Input, DefCallInput, DefCallOutput> call(Class<Input> callInputClass, Function<Input, DeferredCall<DefCallInput, DefCallOutput>> callFactory) {
   ...
   */
  @ApiMayChange
  public <DefCallInput, DefCallOutput extends GeneratedMessageV3> CallStepBuilder<Void, DefCallInput, DefCallOutput> call(Supplier<DeferredCall<DefCallInput, DefCallOutput>> callSupplier) {
   ...
   */
  @ApiMayChange
  public <Input extends GeneratedMessageV3, Output extends GeneratedMessageV3> AsyncCallStepBuilder<Input, Output> asyncCall(Class<Input> callInputClass, Function<Input, CompletionStage<Output>> callFactory) {
   ...
   */
  @ApiMayChange
  public <Output extends GeneratedMessageV3> AsyncCallStepBuilder<Void, Output> asyncCall(Supplier<CompletionStage<Output>> callSupplier) {
