...
public abstract class JsonMigration {
   ...
   * `currentVersion`). If this value is different from {@link JsonMigration#currentVersion} a
   ...
   * `JsonNode` is mutable so you can add and remove fields, or change values. Note that you have to
