 ...
 * <ul>
 *   <li>a pure function.
 *   <li>request conversion - you can use Actions to convert incoming data into a different. format
 *       before forwarding a call to a different component.
 ...
 * </ul>
 *
 * <p>Actions can be triggered in multiple ways. For example, by:
 *
 * <ul>
 ...
 *   <li>an incoming event from an Event Sourced Entity, from within the same service or from a
 *       different service.
...
public abstract class Action {
  ...
  public interface Effect<T> {
    ...
    interface Builder {
       ...
       * element from a subscription. If used as a response to a regular gRPC or HTTP request it is
       * turned into a NotFound response.
       *
       * <p>Ignore is not allowed to have side effects added with `addSideEffects`
       */
      <S> Effect<S> ignore();
    }
    ...
    /**
     * @return true if this effect supports attaching side effects, if returning false
     *     addSideEffects will throw an exception.
     */
