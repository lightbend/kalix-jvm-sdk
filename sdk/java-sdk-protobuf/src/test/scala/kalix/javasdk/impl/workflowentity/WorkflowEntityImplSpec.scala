...
import kalix.javasdk.impl.workflowentity.WorkflowEntityImplSpec.MoneyTransfer
...
import kalix.javasdk.workflowentity.TransferWorkflowEntity
import kalix.javasdk.workflowentity.TransferWorkflowEntityProvider

class WorkflowEntityImplSpec extends AnyWordSpec with Matchers with BeforeAndAfterAll with OptionValues {
  import kalix.testkit.workflowentity.WorkflowMessages._
...
object WorkflowEntityImplSpec {
  ...
  object MoneyTransfer {
    ...
    def testWorkflow: TestWorkflow =
      TestWorkflow.service(TransferWorkflowEntityProvider.of(_ => new TransferWorkflowEntity()));
