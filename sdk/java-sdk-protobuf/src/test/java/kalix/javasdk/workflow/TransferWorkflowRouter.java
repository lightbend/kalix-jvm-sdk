...
public class TransferWorkflowRouter
    extends WorkflowRouter<MoneyTransferApi.State, TransferWorkflow> {
  ...
  public Workflow.Effect handleCommand(
      String commandName, MoneyTransferApi.State state, Object command, CommandContext context) {
    switch (commandName) {
      case "Start":
