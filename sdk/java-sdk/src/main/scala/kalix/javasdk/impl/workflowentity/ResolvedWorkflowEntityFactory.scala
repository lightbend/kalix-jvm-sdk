...
class ResolvedWorkflowEntityFactory(
    delegate: WorkflowEntityFactory,
    override val resolvedMethods: Map[String, ResolvedServiceMethod[_, _]])
    extends WorkflowEntityFactory
    with ResolvedEntityFactory {

  override def create(context: WorkflowEntityContext): WorkflowEntityRouter[_, _] =
