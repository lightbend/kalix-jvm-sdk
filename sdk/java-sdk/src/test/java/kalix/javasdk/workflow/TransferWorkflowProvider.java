...
public class TransferWorkflowProvider implements WorkflowProvider<TransferWorkflow.State, TransferWorkflow> {
  ...
  @Override
  public WorkflowRouter<TransferWorkflow.State, TransferWorkflow> newRouter(WorkflowContext context) {
