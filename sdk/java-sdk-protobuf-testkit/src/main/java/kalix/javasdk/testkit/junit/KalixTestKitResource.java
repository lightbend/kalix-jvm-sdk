...
/**
 * A JUnit 4 external resource for {@link KalixTestKit}, which automatically manages the lifecycle
 * of the testkit. The testkit will be automatically stopped when the test completes or fails.
 *
 * <p>If you prefer JUnit 5 "Jupiter" use {@link KalixTestKitExtension}.
 *
 * <p>Example:
 *
 * <pre>
...
public final class KalixTestKitResource extends ExternalResource {
  ...
  public KalixTestKitResource(
      Kalix kalix, MessageCodec messageCodec, KalixTestKit.Settings settings) {
