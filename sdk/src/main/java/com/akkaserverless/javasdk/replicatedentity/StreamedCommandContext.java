...
public interface StreamedCommandContext<Output> extends CommandContext, MetadataContext {
   ...
   *
   * <p>The callback will be invoked any time the replicated entity changes. The callback may
   * inspect the replicated entity, but any attempt to modify the replicated entity will be ignored
   * and the replicated entity will crash.
   *
   ...
   *
   * <p>An on cancel callback may update the replicated entity, and may emit side effects via the
   * passed in {@link StreamCancelledContext}.
   *
