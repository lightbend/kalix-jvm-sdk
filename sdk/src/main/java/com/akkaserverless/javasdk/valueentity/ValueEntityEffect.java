 ...
 */
public interface ValueEntityEffect<T> {
  ...
  interface Builder<S> {
     ...
     * @param <T> The type of the message that must be returned by this call.
     */
    <T> ValueEntityEffect<T> reply(T message);
     ...
     * @param <T> The type of the message that must be returned by this call.
     */
    <T> ValueEntityEffect<T> reply(T message, Metadata metadata);
     ...
     * @param <T> The type of the message that must be returned by this call.
     */
    <T> ValueEntityEffect<T> forward(ServiceCall serviceCall);
     ...
     * @param <T> The type of the message that must be returned by this call.
     */
    <T> ValueEntityEffect<T> error(String description);
  ...
  interface OnSuccessBuilder<S> {
     ...
     * @param <T> The type of the message that must be returned by this call.
     */
    <T> ValueEntityEffect<T> thenReply(T message);
     ...
     * @param <T> The type of the message that must be returned by this call.
     */
    <T> ValueEntityEffect<T> thenReply(T message, Metadata metadata);
     ...
     * @param <T> The type of the message that must be returned by this call.
     */
    <T> ValueEntityEffect<T> thenForward(ServiceCall serviceCall);
     ...
     * @param <T> The type of the message that must be returned by this call.
     */
    <T> ValueEntityEffect<T> thenNoReply();
  }
   ...
   */
  ValueEntityEffect<T> addSideEffects(Collection<SideEffect> sideEffects);
   ...
   * @return A new reply with the attached effects.
   */
  ValueEntityEffect<T> addSideEffects(SideEffect... effects);
}
