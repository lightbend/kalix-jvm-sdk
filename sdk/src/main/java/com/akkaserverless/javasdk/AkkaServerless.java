...
public final class AkkaServerless {
  ...
  public <T> AkkaServerless register(ValueEntityProvider<T> factory) {
    return register(factory, ValueEntityOptions.defaults());
  }

  public <T> AkkaServerless register(ValueEntityProvider<T> factory, ValueEntityOptions options) {
    return lowLevel()
        .registerValueEntity(
