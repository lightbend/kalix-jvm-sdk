 ...
 *
 * To test an Action create a testkit instance by calling one of the available {@code ActionTestkit.of} methods.
 * The returned testkit can be used as many times as you want. It doesn't preserve any state between invocation.
 *
...
public class ActionTestkit<A extends Action> {
  ...
  /**
   * The call method can be used to simulate a call to the Action.
   * That passed java lambda should return an Action.Effect.
   * The Effect is interpreted into an ActionResult that can be used in test assertions.
   *
