...
- [ ] Check the released artifacts
    ...
    - [ ] Check the core SDK is available in our own repo: `mvn dependency:get -Dartifact=io.kalix:kalix-jvm-core-sdk:$VERSION$ -Dmaven.repo.remote=[YOUR_RESOLVER_FROM_AKKA_IO_SLASH_TOKEN]`
