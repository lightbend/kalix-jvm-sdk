...
TIP: Kickstart a project using the xref:java:quickstart-template.adoc[project template].
...
TIP: To learn more about Kalix entities see xref:java:value-entity.adoc[Implementing Value Entities], xref:java:eventsourced.adoc[Implementing Event Sourced Entities], and xref:java:replicated-entity.adoc[Implementing Replicated Entities].
...
* xref:java:eventsourced.adoc[Event Sourced Entities]
* xref:java:replicated-entity.adoc[Replicated Entities]
...
It is good practice to write unit tests as you implement your services. The kickstart codegen project includes hooks for JUnit testing. For implementation details see the xref:java:quickstart-template.adoc#_3_create_unit_tests[Project template - Create unit tests] topic.
...
https://docs.kalix.io/services/deploy-service.html

* https://docs.kalix.io/services/deploy-service.html[Managing Kalix services]
