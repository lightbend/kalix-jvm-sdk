...
TIP: Kickstart a project using the xref:java:quickstart-java-maven.adoc[Maven archetype].
...
TIP: To learn more about Akka Serverless entities see xref:java:value-entity.adoc[Implementing Value Entities], xref:java:eventsourced.adoc[Implementing Event Sourced Entities], and xref:java:replicated-entity.adoc[Implementing Replicated Entities].
...
It is good practice to write unit tests as you implement your services. The kickstart codegen project includes hooks for JUnit testing. For implementation details see the xref:java:quickstart-java-maven.adoc#_3_create_unit_tests[Java kickstart - Create unit tests] topic.
