...
To add spans in your actions you can add the tracer available in the ActionContext and with it create the span. 

To get the tracer from the ActionContext: 
...
<3> adding some attributes
<4> make the span the current span 
<5> adding some attributes
<6> closing the span
