...
----
include::java-protobuf:example$java-valueentity-counter/src/main/java/com/example/domain/Counter.java[tag=class]
----
...
----
include::java-protobuf:example$scala-valueentity-counter/src/main/scala/com/example/domain/Counter.scala[tag=class]
----
...
./src/main/java/com/example/domain/Counter.java
----
include::java-protobuf:example$java-valueentity-counter/src/main/java/com/example/domain/Counter.java[tag=increase]
----
...
./src/main/java/com/example/domain/Counter.scala
----
include::java-protobuf:example$scala-valueentity-counter/src/main/scala/com/example/domain/Counter.scala[tag=increase]
----
<1> The validation ensures acceptance of positive values and it fails calls with illegal values by returning an `Effect` with `effects.error`.
<2> From the current state we create a new state with the increased value.
<3> We store the new state by returning an `Effect` with `effects.updateState`.
...
.src/main/java/com/example/domain/Counter.java
----
include::java-protobuf:example$java-valueentity-counter/src/main/java/com/example/domain/Counter.java[tag=getCurrentCounter]
----
...
----
include::java-protobuf:example$scala-valueentity-counter/src/main/scala/com/example/domain/Counter.scala[tag=getCurrentCounter]
----
<1> The current state is passed to the method
<2> We use its value to create the `CurrentCounter` value that is sent as a reply by returning an `Effect` with `effects.reply`.
...
----
include::java-protobuf:example$scala-valueentity-counter/src/main/scala/com/example/Main.scala[tag=registration-value-entity]
----
...
./src/main/java/com/example/domain/Counter.java
----
include::java-protobuf:example$java-valueentity-counter/src/main/java/com/example/domain/Counter.java[tag=delete]
----
...
./src/main/java/com/example/domain/Counter.scala
----
include::java-protobuf:example$scala-valueentity-counter/src/main/scala/com/example/domain/Counter.scala[tag=delete]
----
<1> We delete the state by returning an `Effect` with `effects.deleteEntity()`.
