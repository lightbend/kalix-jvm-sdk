...
NOTE: In the example above we take advantage of the TestKit to serialize and deserialize the messages for us. However, the API also offers the possibility to read and write raw bytes if that better suits your use case.
