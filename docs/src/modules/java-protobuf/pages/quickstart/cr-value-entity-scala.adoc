...
[source,command line]
----
curl -OL https://raw.githubusercontent.com/lightbend/kalix-jvm-sdk/main/samples/scala-customer-registry-quickstart/build.sbt
----
...
[source,command line]
----
curl -L https://raw.githubusercontent.com/lightbend/kalix-jvm-sdk/main/samples/scala-customer-registry-quickstart/project/plugins.sbt -o project/plugins.sbt
----
