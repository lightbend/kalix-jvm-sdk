...
----
include::example$java-view-store/src/main/proto/store/product/domain/product_domain.proto[tag=domain]
----
...
.src/main/proto/store/product/domain/product_domain.proto
----
include::example$scala-view-store/src/main/proto/store/product/domain/product_domain.proto[tag=domain]
----
// end::grpc[]
// tag::spring[]
...
----
include::spring:example$spring-view-store/src/main/java/store/product/domain/Product.java[tag=domain]
----
[source,java,indent=0]
.src/main/java/store/product/domain/Money.java
----
include::spring:example$spring-view-store/src/main/java/store/product/domain/Money.java[tag=domain]
----
// tag::grpc[]
...
----
include::example$java-view-store/src/main/proto/store/order/domain/order_domain.proto[tag=domain]
----
...
.src/main/proto/store/order/domain/order_domain.proto
----
include::example$scala-view-store/src/main/proto/store/order/domain/order_domain.proto[tag=domain]
----
// end::grpc[]
// tag::spring[]
[source,java,indent=0]
...
----
include::spring:example$spring-view-store/src/main/java/store/order/domain/Order.java[tag=domain]
----
// end::spring[]
// tag::grpc[]
...
----
include::example$java-view-store/src/main/proto/store/view/joined/orders_view.proto[tag=updates]
----
...
.src/main/proto/store/view/joined/orders_view.proto
----
include::example$scala-view-store/src/main/proto/store/view/joined/orders_view.proto[tag=updates]
----
<1> Each update method stores its state type in a different table for `customers`, `products`, and `orders`.
...
.src/main/proto/store/view/joined/orders_view.proto
----
include::example$java-view-store/src/main/proto/store/view/joined/orders_view.proto[tag=query]
----
...
.src/main/proto/store/view/joined/orders_view.proto
----
include::example$scala-view-store/src/main/proto/store/view/joined/orders_view.proto[tag=query]
----
<1> The service method returns a stream of customer orders.
<2> Select all columns from the joined entries to project into the combined `CustomerOrder` result type.
<3> Join customers with orders on a matching customer id.
...
To do this, implement a `MultiViewTable` component, with a nested `ViewTable` component for each of the entities, where each `ViewTable` is implemented in a similar way to a single-table `View`.
...
----
include::spring:example$spring-view-store/src/main/java/store/view/joined/CustomerOrder.java[tag=joined]
----

[source,java,indent=0]
.src/main/java/store/view/joined/JoinedCustomerOrdersView.java
----
include::spring:example$spring-view-store/src/main/java/store/view/joined/JoinedCustomerOrdersView.java[tag=join]
----
<1> An optional view id for this multi-table view.
<2> Create a `MultiTableView` component.
...
<4> The query method returns a stream of customer orders.
<5> Each `ViewTable` stores its state type in a different table for `customers`, `products`, and `orders`.
// tag::grpc[]
...
----
include::example$java-view-store/src/main/proto/store/view/nested/orders_view.proto[tag=query]
----
...
.src/main/proto/store/view/nested/orders_view.proto
----
include::example$scala-view-store/src/main/proto/store/view/nested/orders_view.proto[tag=query]
----
<1> A single `CustomerOrders` message is returned, which will have the customer details and all orders for this customer.
<2> The customer columns are projected into the result message, and the order and product columns are combined into a nested message and projected into the `orders` field.
<3> The `orders` (repeated) field will contain the nested `CustomerOrder` messages.
...
----
include::spring:example$spring-view-store/src/main/java/store/view/nested/CustomerOrders.java[tag=nested]
----
...
----
include::spring:example$spring-view-store/src/main/java/store/view/nested/CustomerOrder.java[tag=nested]
----

[source,java,indent=0]
.src/main/java/store/view/nested/NestedCustomerOrdersView.java
----
include::spring:example$spring-view-store/src/main/java/store/view/nested/NestedCustomerOrdersView.java[tag=query]
----
...
----
include::example$java-view-store/src/main/proto/store/view/structured/orders_view.proto[tag=query]
----
...
.src/main/proto/store/view/structured/orders_view.proto
----
include::example$scala-view-store/src/main/proto/store/view/structured/orders_view.proto[tag=query]
----
<1> The `customer_id` is renamed to just `id` in the result type.
<2> Customer shipping details are transformed and combined into a nested message.
<3> The product price is reconstructed into a `ProductValue` message, nested within the order message.
...
----
include::spring:example$spring-view-store/src/main/java/store/view/structured/CustomerOrders.java[tag=structured]
----

[source,java,indent=0]
.src/main/java/store/view/structured/CustomerShipping.java
----
include::spring:example$spring-view-store/src/main/java/store/view/structured/CustomerShipping.java[tag=structured]
----

[source,java,indent=0]
.src/main/java/store/view/structured/ProductOrder.java
----
include::spring:example$spring-view-store/src/main/java/store/view/structured/ProductOrder.java[tag=structured]
----

[source,java,indent=0]
.src/main/java/store/view/structured/ProductValue.java
----
include::spring:example$spring-view-store/src/main/java/store/view/structured/ProductValue.java[tag=structured]
----

[source,java,indent=0]
.src/main/java/store/view/structured/StructuredCustomerOrdersView.java
----
include::spring:example$spring-view-store/src/main/java/store/view/structured/StructuredCustomerOrdersView.java[tag=query]
----
...
----
include::example$java-view-store/src/it/java/store/view/joined/JoinedCustomerOrdersViewIntegrationTest.java[tag=testkit-advanced-views]
----
...
----
include::example$scala-view-store/src/test/scala/store/view/joined/JoinedCustomerOrdersIntegrationSpec.scala[tag=testkit-advanced-views]
----
// end::grpc[]
// tag::spring[]
[source,java,indent=0]
...
----
include::spring:example$spring-view-store/src/it/java/store/view/TestKitConfig.java[tag=testkit-advanced-views]
----
// tag::grpc[]
