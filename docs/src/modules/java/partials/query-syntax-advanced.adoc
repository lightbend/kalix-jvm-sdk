...
----
include::spring:example$java-spring-view-store/src/main/java/store/product/domain/Product.java[tag=domain]
----
[source,java,indent=0]
.src/main/java/store/product/domain/Money.java
----
include::spring:example$java-spring-view-store/src/main/java/store/product/domain/Money.java[tag=domain]
----
// tag::grpc[]
...
----
include::spring:example$java-spring-view-store/src/main/java/store/order/domain/Order.java[tag=domain]
----
// end::spring[]
// tag::grpc[]
...
----
include::spring:example$java-spring-view-store/src/main/java/store/view/joined/CustomerOrder.java[tag=joined]
----

[source,java,indent=0]
.src/main/java/store/view/joined/JoinedCustomerOrdersView.java
----
include::spring:example$java-spring-view-store/src/main/java/store/view/joined/JoinedCustomerOrdersView.java[tag=join]
----
...
----
include::spring:example$java-spring-view-store/src/main/java/store/view/nested/CustomerOrders.java[tag=nested]
----
...
----
include::spring:example$java-spring-view-store/src/main/java/store/view/nested/CustomerOrder.java[tag=nested]
----

[source,java,indent=0]
.src/main/java/store/view/nested/NestedCustomerOrdersView.java
----
include::spring:example$java-spring-view-store/src/main/java/store/view/nested/NestedCustomerOrdersView.java[tag=query]
----
...
----
include::spring:example$java-spring-view-store/src/main/java/store/view/structured/CustomerOrders.java[tag=structured]
----

[source,java,indent=0]
.src/main/java/store/view/structured/CustomerShipping.java
----
include::spring:example$java-spring-view-store/src/main/java/store/view/structured/CustomerShipping.java[tag=structured]
----

[source,java,indent=0]
.src/main/java/store/view/structured/ProductOrder.java
----
include::spring:example$java-spring-view-store/src/main/java/store/view/structured/ProductOrder.java[tag=structured]
----

[source,java,indent=0]
.src/main/java/store/view/structured/ProductValue.java
----
include::spring:example$java-spring-view-store/src/main/java/store/view/structured/ProductValue.java[tag=structured]
----

[source,java,indent=0]
.src/main/java/store/view/structured/StructuredCustomerOrdersView.java
----
include::spring:example$java-spring-view-store/src/main/java/store/view/structured/StructuredCustomerOrdersView.java[tag=query]
----
...
----
include::spring:example$java-spring-view-store/src/it/java/store/view/TestKitConfig.java[tag=testkit-advanced-views]
----
// tag::grpc[]
