...
It also contains the configuration to start a local Google Pub/Sub emulator that the Akka Serverless proxy will connect to when you make use of xref:java:topic-eventing.adoc[] in your service.
