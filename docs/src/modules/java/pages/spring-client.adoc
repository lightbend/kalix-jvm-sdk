...
* https://github.com/lightbend/akkaserverless-java-sdk/tree/main/samples/java-valueentity-counter-spring-client[Spring Client Java Value Entity Counter,window="new"]
