...
----
include::example$java-spring-transfer-workflow/src/main/java/com/example/transfer/TransferWorkflowEntity.java[tag=class]
----
...
.src/main/java/com/example/transfer/TransferWorkflowEntity.java
----
include::example$java-spring-transfer-workflow/src/main/java/com/example/transfer/TransferWorkflowEntity.java[tag=start]
----
...
.src/main/java/com/example/transfer/TransferWorkflowEntity.java
----
include::example$java-spring-transfer-workflow/src/main/java/com/example/transfer/TransferWorkflowEntity.java[tag=definition]
----
...
.src/main/java/com/example/transfer/TransferWorkflowEntity.java
----
include::example$java-spring-transfer-workflow/src/main/java/com/example/transfer/TransferWorkflowEntity.java[tag=get-transfer]
----
