...
Most important, in this file we instruct the Akka Serverless Codegen which kind of component we want to create. The codegen will generated all stubs for your entity/service and corresponding tests, as well as an abstract class for your implementation to extend.
