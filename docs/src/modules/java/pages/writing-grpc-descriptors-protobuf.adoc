...
.src/main/proto/com/example/shoppingcart/hoppingcart_api.proto
[source,proto]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart/domain/shoppingcart_domain.proto[tag=proto_syntax]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart/domain/shoppingcart_domain.proto[tag=proto_imports]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart/domain/shoppingcart_domain.proto[tag=proto_state]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart/domain/shoppingcart_domain.proto[tag=proto_messages]
----
