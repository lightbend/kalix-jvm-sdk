...
.src/main/proto/com/example/shoppingcart_api.proto
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart_api.proto[tag=proto_syntax]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart_api.proto[tag=proto_imports]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart_api.proto[tag=proto_package]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart_api.proto[tag=proto_messages]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/shoppingcart_api.proto[tag=proto_service]
----
...
.src/main/proto/com/example/domain/shoppingcart_domain.proto
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/domain/shoppingcart_domain.proto[tag=proto_syntax]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/domain/shoppingcart_domain.proto[tag=proto_imports]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/domain/shoppingcart_domain.proto[tag=proto_state]
----
...
[source,proto]
----
include::example$java-valueentity-shopping-cart/src/main/proto/com/example/domain/shoppingcart_domain.proto[tag=proto_messages]
----
