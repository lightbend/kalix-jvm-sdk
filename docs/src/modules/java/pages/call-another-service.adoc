...
----
include::java:example$java-protobuf-doc-snippets/src/main/proto/com/example/counter_api.proto[tag=other-service-api]
----
...
----
include::java:example$java-protobuf-doc-snippets/src/main/java/com/example/DelegatingServiceAction.java[tag=delegating-action]
----
+
