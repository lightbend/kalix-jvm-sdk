...
xref:java:spring-boot-integration.adoc#_dependency_injection[Dependency injection] page for more details on how Kalix components integrates
...
TIP: For more details see xref:java:development-process-spring.adoc#_package_service[Development Process - Package service].
...
- Deploy your service following the instructions at xref:java:development-process-spring.adoc#_deploy_to_kalix[Development Process - Deploy to Kalix].
