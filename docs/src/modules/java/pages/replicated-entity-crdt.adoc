...
<8> The protobuf option `(kalix.codegen)`  is specific to code-generation as provided by the Akka Serverless Maven plugin.
...
<7> The protobuf option `(kalix.codegen)`  is specific to code-generation as provided by the Akka Serverless Maven plugin.
