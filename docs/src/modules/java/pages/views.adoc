...
----
include::java:example$java-customer-registry/src/main/proto/customer/customer_domain.proto[tags=declations;domain]
----
...
[source,proto,indent=0]
----
include::java:example$java-customer-registry/src/main/proto/customer/customer_view.proto[tags=declations;ervice-event-sourced]
----
...
[source,proto,indent=0]
----
include::java:example$java-customer-registry/src/main/proto/customer/customer_view.proto[tags=declations;ervice-topic]
----
