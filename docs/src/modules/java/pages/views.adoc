...
----
include::java:example$java-valueentity-customer-registry/src/main/proto/customer/customer_domain.proto[tags=declarations;domain]
----
...
[source,proto,indent=0]
----
include::java:example$java-valueentity-customer-registry/src/main/proto/customer/customer_view.proto[tags=declarations;service]
----
...
[source,proto,indent=0]
----
include::java:example$java-valueentity-customer-registry/src/main/proto/customer/customer_view.proto[tag=unary]
----
...
----
include::java:example$java-valueentity-customer-registry/src/main/java/customer/Main.java[tag=register]
----
...
[source,proto,indent=0]
----
include::java:example$java-eventsourced-customer-registry/src/main/proto/customer/customer_domain.proto[tags=declarations;events]
----
...
[source,proto,indent=0]
----
include::java:example$java-eventsourced-customer-registry/src/main/proto/customer/customer_view.proto[tags=declarations;service-event-sourced]
----
...
Next, you need to define a Java class that transforms events to state that can be used in the View. An Event Sourced entity can emit many types of events. If a View does not use
all events, you need to ignore unneeded events as shown in the `IgnoreOtherEvents` `UpdateHandler`:

[source,java,indent=0]
----
include::java:example$java-eventsourced-customer-registry/src/main/java/customer/view/CustomerByNameView.java[tag=process-events]
----

<1> The class must have the link:{attachmentsdir}/api/com/akkaserverless/javasdk/view/View.html[`@View`] annotation.
<2> It extends the generated `AbstractCustomerByNameViewImpl` which requires all link:{attachmentsdir}/api/com/akkaserverless/javasdk/view/UpdateHandler.html[`@UpdateHandler`] methods.
...
[source,java,indent=0]
----
include::java:example$java-eventsourced-customer-registry/src/main/java/customer/Main.java[tag=register-with-class]
----
...
[source,proto,indent=0]
----
include::java:example$java-eventsourced-customer-registry/src/main/proto/customer/customer_view.proto[tags=declarations;service-topic]
----
...
[source,proto,indent=0]
----
include::java:example$java-valueentity-customer-registry/src/main/proto/customer/customer_view.proto[tag=summary]
----
...
[source,proto,indent=0]
----
include::java:example$java-valueentity-customer-registry/src/main/proto/customer/customer_view.proto[tag=wrap-repeated]
----
