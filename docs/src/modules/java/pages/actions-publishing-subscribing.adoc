...
For details about how to set up the connection to https://cloud.google.com/pubsub/docs/overview[Google Cloud Pub/Sub] or Apache Kafka see
https://developer.lightbend.com/docs/akka-serverless/projects/message-brokers.html[Configure message brokers]
