...
To save the work of starting from scratch, the Java xref:java:quickstart-template.adoc[code generation tool] creates a project from a template, complete with descriptors and implementations. Or, you can start from one of our fully implemented https://docs.kalix.io/quickstart/index.html[Quickstart applications].
