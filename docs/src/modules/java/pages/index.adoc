...
The Akka Serverless Java SDK guides you to implementing components matching the protobuf APIs you design. This page describes prerequisites for Java development and basic requirements for a development project.
