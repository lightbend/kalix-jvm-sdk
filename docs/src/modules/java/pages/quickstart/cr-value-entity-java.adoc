...
----
include::example$java-customer-registry-quickstart/src/main/proto/customer/action/customer_action.proto[tag=declarations]
----
...
.src/main/proto/customer/action/customer_action.proto
----
include::example$java-customer-registry-quickstart/src/main/proto/customer/action/customer_action.proto[tag=service]
----
...
----
include::example$java-customer-registry-quickstart/src/main/java/customer/action/CustomerStateSubscriptionAction.java[tag=upsert]
----
+
...
. Check your message broker is configured after following the https://developer.lightbend.com/docs/akka-serverless/projects/message-brokers.html[Configure message brokers] instructions.
