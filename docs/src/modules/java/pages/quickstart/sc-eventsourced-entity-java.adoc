...
----
include::example$java-shopping-cart-quickstart/src/main/proto/shopping/cart/api/shopping_cart_api.proto[tag=declarations]
----

. Add the service endpoint. The service endpoint is annotated with `akkaserverless.codegen` indicating we want to generate an Event Sourced Entity for this service.
+
[source,proto,indent=0]
.src/main/proto/shopping/cart/api/shopping_cart_api.proto
----
include::example$java-shopping-cart-quickstart/src/main/proto/shopping/cart/api/shopping_cart_api.proto[tag=service]
----
...
.src/main/proto/shopping/cart/api/shopping_cart_api.proto
----
include::example$java-shopping-cart-quickstart/src/main/proto/shopping/cart/api/shopping_cart_api.proto[tag=messages]
----
...
----
include::example$java-shopping-cart-quickstart/src/main/proto/shopping/cart/domain/shopping_cart_domain.proto[tag=declarations]
----
...
.src/main/proto/shopping/cart/domain/shopping_cart_domain.proto
----
include::example$java-shopping-cart-quickstart/src/main/proto/shopping/cart/domain/shopping_cart_domain.proto[tag=state]
----
...
.src/main/proto/shopping/cart/domain/shopping_cart_domain.proto
----
include::example$java-shopping-cart-quickstart/src/main/proto/shopping/cart/domain/shopping_cart_domain.proto[tag=events]
----
...
----
include::example$java-shopping-cart-quickstart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=imports]
----
+
...
.src/main/java/shopping/cart/domain/ShoppingCartEntity.java
----
include::example$java-shopping-cart-quickstart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=emptyState]
----
+
...
.src/main/java/shopping/cart/domain/ShoppingCartEntity.java
----
include::example$java-shopping-cart-quickstart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=addItem]
----
+
...
.src/main/java/shopping/cart/domain/ShoppingCartEntity.java
----
include::example$java-shopping-cart-quickstart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=getCart]
----
+
...
.src/main/java/shopping/cart/domain/ShoppingCartEntity.java
----
include::example$java-shopping-cart-quickstart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=removeItem]
----
+
...
.src/main/java/shopping/cart/domain/ShoppingCartEntity.java
----
include::example$java-shopping-cart-quickstart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=itemAdded]
----
+
...
.src/main/java/shopping/cart/domain/ShoppingCartEntity.java
----
include::example$java-shopping-cart-quickstart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=itemRemoved]
----
+
