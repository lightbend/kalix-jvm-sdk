...
[source,command line]
----
curl -OL https://raw.githubusercontent.com/lightbend/akkaserverless-java-sdk/main/samples/java-customer-registry-kafka-quickstart/pom.xml
----
...
----
include::example$java-customer-registry-kafka-quickstart/src/main/proto/customer/api/customer_api.proto[tag=declarations]
----
...
.src/main/proto/customer/api/customer_api.proto
----
include::example$java-customer-registry-kafka-quickstart/src/main/proto/customer/api/customer_api.proto[tag=service]
----
...
.src/main/proto/customer/api/customer_api.proto
----
include::example$java-customer-registry-kafka-quickstart/src/main/proto/customer/api/customer_api.proto[tag=messages]
----
...
.src/main/proto/customer/api/customer_api.proto
----
include::example$java-customer-registry-kafka-quickstart/src/main/proto/customer/api/customer_api.proto[tag=method-messages]
----

== Define an Action

The Customer Registry service will publish an event each time a customer is created or updated. The `customer_cation.proto` will contain the definition of this action.
...
----
include::example$java-customer-registry-kafka-quickstart/src/main/proto/customer/domain/customer_domain.proto[tag=declarations]
----
...
.src/main/proto/customer/domain/customer_domain.proto
----
include::example$java-customer-registry-kafka-quickstart/src/main/proto/customer/domain/customer_domain.proto[tag=domain]
----
...
----
include::example$java-customer-registry-kafka-quickstart/src/main/java/customer/domain/Customer.java[tag=create]
----
+
...
.src/main/java/customer/domain/Customer.java
----
include::example$java-customer-registry-kafka-quickstart/src/main/java/customer/domain/Customer.java[tag=getCustomer]
----
+
...
Actions are stateless functions that can be triggered in multiple ways. In this case by each event `customer.domain.CustomerState` received by the Value Entity `customer.domain.Customer`. 
...
----
+
* The incoming message contains the request data from your client and this action just passes it along to the xref:java:actions-publishing-subscribing.adoc[Pub/Sub] mechanism of your choice.
...
. Check your message broker is configured by following the https://developer.lightbend.com/docs/akka-serverless/projects/message-brokers.html[Configure message brokers] how-to.
