...
The ports can be configured in the `.env` at the project's root folder.

[source,indent=0]
----
include::java:example$java-spring-eventsourced-customer-registry-subscriber/.env[tag=customer-registry-subscriber]
----
