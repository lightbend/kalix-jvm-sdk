...
.src/main/java/com/example/shoppingcart/domain/ShoppingCart.java
----
include::example$java-eventsourced-shopping-cart/src/main/java/com/example/shoppingcart/domain/ShoppingCart.java[tag=checkout]
----
...
.src/main/scala/com/example/shoppingcart/domain/ShoppingCart.scala
----
include::example$scala-eventsourced-shopping-cart/src/main/scala/com/example/shoppingcart/domain/ShoppingCart.scala[tag=checkout]
----
<1> Emit a final event before deletion, which is handled as any other event.
<2> Instruction to delete the entity.
