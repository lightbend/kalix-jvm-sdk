...
[.group-scala]
== sbt Giter8 template
A https://github.com/foundweekends/giter8[Giter8 template]; https://github.com/lightbend/akkaserverless-value-entity.g8[lightbend/akkaserverless-value-entity.g8] provides the tooling to xref:quickstart-template.adoc[kickstart an sbt project]. The Giter8 template can be used via the `sbt` CLI.
