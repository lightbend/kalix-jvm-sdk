...
We can test this Event Sourced Entity implementation with the ShoppingCartTestkit. This class is generated by AkkaServerless when this project is compiled.
