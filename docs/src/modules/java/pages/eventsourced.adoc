...
[source,java]
----
include::example$testkit/java-eventsourced-shopping-cart/intarget/generated-test-sources/akkaserverless/com/example/shoppingcart/domain/ShoppingCartTestKit.java[] 
----
...
[source,java]
----
include::example$testkit/com/akkaserverless/javasdk/testkit/EventSourcedResult.java[tag=available-methods] 
----
