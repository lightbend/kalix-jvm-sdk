...
[source,java,indent=0]
----
include::example$java-eventing-shopping-cart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=snapshot]
----
...
[source,java,indent=0]
----
include::example$java-eventing-shopping-cart/src/main/java/shopping/cart/domain/ShoppingCartEntity.java[tag=handleSnapshot]
----
