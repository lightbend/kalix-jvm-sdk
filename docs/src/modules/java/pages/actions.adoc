...
.src/main/proto/com/example/fibbonacci/fibonacci.proto
----
include::example$java-fibonacci-action/src/main/proto/com/example/fibbonacci/fibonacci.proto[tag=actions]
----
