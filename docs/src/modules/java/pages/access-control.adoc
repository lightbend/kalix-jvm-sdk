...
This section describes the practical aspects of configuring Access Control Lists (ACLs) with the Java/Scala SDKs, if you are not sure what ACLs are or how they work, see https://docs.kalix.io/security/acls.html[Access Control Lists] first.
