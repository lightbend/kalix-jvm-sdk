...
----
include::example$spring-valueentity-counter/src/main/java/com/example/action/DoubleCounterAction.java[tag=controller-side-effect]
----
...
Please note that, the result of a side effect is ignored by the command meaning that even if the call to
