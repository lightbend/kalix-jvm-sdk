...
The following sections walk through these steps using a shopping cart service as an example (working sample available {sample-url}[here {tab-icon}, window="new"]). {tab-icon}, window="new"]
...
.src/main/java/com/example/shoppingcart/ShoppingCartEntity.java
----
include::example$spring-eventsourced-shopping-cart/src/main/java/com/example/shoppingcart/ShoppingCartEntity.java[tag=checkout]
----
