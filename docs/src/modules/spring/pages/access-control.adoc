...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/MyAction.java[tag=allow-deny]
----
...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/MyAction.java[tag=all-traffic]
----
...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/MyAction.java[tag=internet]
----
To allow traffic from `service-a` and `service-b`:

[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/MyAction.java[tag=multiple-services]
----
To block all traffic, an ACL with no allows can be configured:

[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/MyAction.java[tag=block-traffic]
----
...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/EmployeeAction.java[tag=acl]
----
...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/EmployeeAction.java[tag=acl1]
----
...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/Main.java[tag=acl]
----
...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/MyAction.java[tag=deny-code]
----
...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/UserAction.java[tag=acl]
----
...
[source, java]
----
include::example$spring-doc-snippets/src/main/java/com/example/MyAction.java[tag=open-subscription-acl]
----
