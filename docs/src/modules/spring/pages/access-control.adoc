...
This section describes the practical aspects of configuring Access Control Lists (ACLs) with the Spring SDK, if you are not sure what ACLs are or how they work, see https://docs.kalix.io/security/acls.html[Understanding ACLs] first.
...
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/MyAction.java[tag=allow-deny]
----
...
[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/MyAction.java[tag=all-traffic]
----
...
[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/MyAction.java[tag=internet]
----
To allow traffic from `service-a` and `service-b`:

[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/MyAction.java[tag=multiple-services]
----
To block all traffic, an ACL with no allows can be configured:

[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/MyAction.java[tag=block-traffic]
----
...
[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/EmployeeAction.java[tag=acl]
----
...
[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/EmployeeAction.java[tag=acl1]
----
...
[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/Main.java[tag=acl]
----
...
[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/MyAction.java[tag=deny-code]
----
...
[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/UserAction.java[tag=acl]
----
...
[source, java, indent=0]
----
include::example$spring-doc-snippets/src/main/java/com/example/acl/MyAction.java[tag=open-subscription-acl]
----
...
[source, java]
----
include::example$spring-eventsourced-counter/src/it/java/com/example/TestkitConfig.java[tag=class]
----
...
[source, java]
----
include::example$spring-eventsourced-counter/src/it/java/com/example/CounterIntegrationTest.java[tag=class]
----
