...
[source, java]
----
include::example$spring-acl-examples/src/main/java/com/example/MyAction.java[tag=acl1]
----
...
[source, java]
----
include::example$spring-acl-examples/src/main/java/com/example/MyAction.java[tag=acl2]
----
...
[source, java]
----
include::example$spring-acl-examples/src/main/java/com/example/MyAction.java[tag=acl3]
----
To allow traffic from `service-a` and `service-b`:

[source, java]
----
include::example$spring-acl-examples/src/main/java/com/example/MyAction.java[tag=acl4]
----
To block all traffic, an ACL with no allows can be configured:

[source, java]
----
include::example$spring-acl-examples/src/main/java/com/example/MyAction.java[tag=acl5]
----
...
[source, java]
----
include::example$spring-acl-examples/src/main/java/com/example/MyAction.java[tag=acl6]
----
