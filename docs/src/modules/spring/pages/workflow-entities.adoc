...
:sample-url: https://github.com/lightbend/kalix-jvm-sdk/tree/main/samples/java-spring-reliable-timers
...
----
include::example$java-spring-reliable-timers/src/main/java/com/example/wallet/WalletEntity.java[tag=wallet]
----
...
----
include::example$java-spring-reliable-timers/src/main/java/com/example/transfer/TransferState.java[tag=domain]
----
...
----
include::example$java-spring-reliable-timers/src/main/java/com/example/transfer/TransferWorkflowEntity.java[tag=class]
----
...
.src/main/java/com/example/transfer/TransferWorkflowEntity.java
----
include::example$java-spring-reliable-timers/src/main/java/com/example/transfer/TransferWorkflowEntity.java[tag=start]
----
...
.src/main/java/com/example/transfer/TransferWorkflowEntity.java
----
include::example$java-spring-reliable-timers/src/main/java/com/example/transfer/TransferWorkflowEntity.java[tag=definition]
----
...
.src/main/java/com/example/transfer/TransferWorkflowEntity.java
----
include::example$java-spring-reliable-timers/src/main/java/com/example/transfer/TransferWorkflowEntity.java[tag=get-transfer]
----
