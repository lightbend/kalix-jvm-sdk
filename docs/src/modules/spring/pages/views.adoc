...
ifdef::todo[TODO: complete with example for transformed results github.com/lightbend/kalix/issues/7884]
...
include::ROOT:partial$query-syntax-paging.adoc[tag=spring]
