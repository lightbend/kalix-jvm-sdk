...
Instead of using `SELECT *` you can define which columns will be used in the response message. So, if you want to use a `CustomerSummary` as below as the response:
