...
----
include::example$java-spring-customer-registry-views-quickstart/src/main/java/customer/api/Customer.java[tags=class]
----
...
[source,java]
----
include::example$java-spring-customer-registry-views-quickstart/src/main/java/customer/view/CustomerByNameView.java[tags=class]
----
<1> defining view ID
...
----
include::example$java-spring-valueentity-customer-registry/src/main/java/com/example/api/CustomerSummary.java[tag=record]
----
...
----
include::example$java-spring-valueentity-customer-registry/src/main/java/com/example/view/CustomerSummaryByName.java[tag=class]
----
...
.src/main/java/com/example/api/CustomerSummaryByName.java
----
include::example$java-spring-valueentity-customer-registry/src/main/java/com/example/view/CustomerSummaryByName.java[tag=delete]
----
...
IMPORTANT: It's highly recommended to add a `@TypeName` to your persisted events. Kalix needs to identify each event in order to deliver them to the right event handlers. If no logical type name is specified, Kalix uses the non-qualified class name. Once an event is persisted in Kalix, you won't be able to rename your class if no logical type name has been specified, as Kalix won't be able to recognize previously persisted events. Therefore, we recommend all event classes use a logical type name.
...
----
include::example$java-spring-valueentity-customer-registry/src/main/java/com/example/view/CustomersStreamByName.java[tag=class]
----
...
----
include::example$java-spring-valueentity-customer-registry/src/main/java/com/example/api/CustomersResponse.java[tag=record]
----

[source,java,indent=0]
.src/main/java/com/example/api/CustomersResponseByName.java
----
include::example$java-spring-valueentity-customer-registry/src/main/java/com/example/view/CustomersResponseByName.java[tag=class]
----
<1> View state type is the original `Customer` as shown at the beginning of this section.
<2> Query is mapped to an external route as usual receiving a `customerName` as parameter.
...
[#query]
include::java:partial$query-syntax-reference.adoc[tag=spring]

include::java:partial$query-syntax-paging.adoc[tag=spring]

include::java:partial$query-syntax-advanced.adoc[tag=spring]
