...
----
include::example$spring-valueentity-customer-registry/src/main/java/com/example/api/CustomerSummary.java[tag=record]
----
...
----
include::example$spring-valueentity-customer-registry/src/main/java/com/example/view/CustomerSummaryByName.java[tag=class]
----
...
.src/main/java/com/example/api/CustomerSummaryByName.java
----
include::example$spring-valueentity-customer-registry/src/main/java/com/example/view/CustomerSummaryByName.java[tag=delete]
----
...
----
include::example$spring-valueentity-customer-registry/src/main/java/com/example/view/CustomersStreamByName.java[tag=class]
----
...
----
include::example$spring-valueentity-customer-registry/src/main/java/com/example/api/CustomersResponse.java[tag=record]
----

[source,java,indent=0]
.src/main/java/com/example/api/CustomersResponseByName.java
----
include::example$spring-valueentity-customer-registry/src/main/java/com/example/view/CustomersResponseByName.java[tag=class]
----
<1> View state type is the original `Customer` as shown at the beginning of this section.
<2> Query is mapped to an external route as usual receiving a `customerName` as parameter.
