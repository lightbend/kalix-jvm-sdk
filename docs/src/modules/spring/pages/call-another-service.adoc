...
The Kalix Spring SDK provides a utility class calls `WebClientProvider` that can provide already configured `WebClients` for other Kalix services deployed on the same Kalix project.
